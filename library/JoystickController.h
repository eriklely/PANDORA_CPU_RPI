...
{
  enum { ABS_X=0, ABS_Y, ABS_RX, ABS_Z, ABS_RZ, ABS_RY, ABS_THROTTLE, ABS_RUDDER, ABS_WHEEL, ABS_HAT0X, ABS_HAT0Y, ABS_DISTANCE, ABS_TILT_X, ABS_TILT_Y }; 
}

namespace JOYSTICK_BUTTONS
{
    enum { SQUARE=0, X, CIRCLE, TRI, L1, R1, L2, R2, START_SHARE, SELECT_OPT, L3, R3, PS, TRACK, D_UP, D_RIGHT, D_DOWN, D_LEFT };
